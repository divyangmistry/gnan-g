...
class MonthlyLeaderBoard extends StatefulWidget {
  @override
  MonthlyLeaderBoardState createState() => new MonthlyLeaderBoardState();
}

class MonthlyLeaderBoardState extends BaseState<MonthlyLeaderBoard> {
    ...
    Widget topSection = Container(
      child: Column(
        children: <Widget>[
          ...
          _buildUserRow(1, CacheData.userState.totalscore_month)
        ],
      ),
    );
...
//                Image leaderImage = CommonFunction.getImageFromBase64Img(base64Img:leaderList[index].img, returnDefault: true);
                return LeaderRow(
                  ...
                  leaderList[index].totalscoreMonth,
                  Icons.face,
                  null,
