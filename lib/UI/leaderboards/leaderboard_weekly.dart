...
class WeeklyLeaderBoard extends StatefulWidget {
  @override
  WeeklyLeaderBoardState createState() => new WeeklyLeaderBoardState();
}

class WeeklyLeaderBoardState extends BaseState<WeeklyLeaderBoard> {
  ...
  _loadLeadersAndRank() async {
    ...
    try {
      Response res = await _api.getApi(url: '/leaders_week');
    ...
    Widget topSection = Container(
      child: Column(
        children: <Widget>[
          ...
          _buildUserRow(1, CacheData.userState.totalscore_week)
        ],
      ),
    );
...
//                Image leaderImage = CommonFunction.getImageFromBase64Img(base64Img:leaderList[index].img, returnDefault: true);
                return LeaderRow(
                  ...
                  leaderList[index].totalscoreWeek,
                  Icons.face,
                  null,
